...
class IdMeVariable
{
    ...
    {
        $html = '<div style="display:inline-flex; height:52px; gap:10px; margin:10px 0; padding:16px; color:white; background-color:#2E3F51; border-radius:5px;"><img src="https://s3.amazonaws.com/idme-design/brand-assets/Primary-IDme-Logo-RGB-white.png" alt="id.me" style="height:100%; "/> <span>Verified</span></div>';
